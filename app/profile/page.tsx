...
const Profile = () => {
  ...
  // const trialStatusMap: Record<TrialStatus, { label: string; color: string }> =
  //   {
  //     [TrialStatus.NOT_SUBMITTED]: {
  //       label: 'Trial Not Requested',
          ...
          <div className="bg-card rounded-lg border border-border/50 overflow-hidden shadow-md">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                ...
                <div className="p-4 rounded-md bg-secondary/30 border border-border/50">
                  <div className="flex items-center gap-2 mb-2">
                    <CreditCard size={16} className="text-primary/80" />
                    <span className="text-sm font-medium">Current Plan</span>
                  </div>
                  <p
                    className={`text-sm font-medium ${planColorMap[user.plan]}`}
                  >
                ...
                {/* <div className="p-4 rounded-md bg-secondary/30 border border-border/50">
                  <div className="flex items-center gap-2 mb-2">
                    <Timer size={16} className="text-primary/80" />
                    <span className="text-sm font-medium">Trial Status</span>
                  </div>
                  <p
                    className={`text-sm font-medium ${trialStatusMap[trialStatus].color}`}
                  >
                    {trialStatusMap[trialStatus].label}
                  </p>
                </div> */}
